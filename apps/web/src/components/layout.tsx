      ...
      >
        <defs>
          <radialGradient id={`${id}-desktop`} cx="100%">
            <stop offset="0%" stopColor="rgba(56, 250, 248, 0.3)" />
            <stop offset="53.95%" stopColor="rgba(0, 240, 255, 0.09)" />
            <stop offset="100%" stopColor="rgba(10, 64, 23, 0)" />
          </radialGradient>

          <radialGradient id={`${id}-mobile`} cy="100%">
            <stop offset="0%" stopColor="rgba(56, 239, 248, 0.3)" />
            <stop offset="53.95%" stopColor="rgba(0, 121, 255, 0.09)" />
            <stop offset="100%" stopColor="rgba(10, 64, 23, 0)" />
          </radialGradient>
        </defs>
        <rect
